...
/*   for run,screen rotation buttons and screen size*/
.trytopnav {
  height:40px;
  overflow:hidden;
  min-width:380px;
...
#textareaCode {
/*  background-color: #ffffff;*/
/*  background-color:#FFDB58; changed */
  ...
  <div class="w3-modal-content">
    <div class="w3-display-container">
      ...
      <div id="driveText" class="w3-panel w3-large">
        ...
        <input class="w3-input w3-border" type="text" id="googleFileName" value="tryhtml_basic_document">
...
<!--  <a href="javascript:void(0);" onclick="openMenu()" id="menuButton" title="Open Menu"class="w3-dropdown-click w3-button w3-bar-item topnav-icons fa fa-menu" style="font-size:28px;color:#999999;margin-top:-2px"></a>-->
  <a href="javascript:void(0);" onclick="restack(currentStack)" title="Change Orientation"class="w3-btn w3-bar-item" style="font-size:28px;color:#999999;margin-top:-2px" ><i class="material-icons" style="font-size:30px padding:8px 0;display:block;float:right; color: darkgreen">screen_rotation</i></a>
<!--    <a href="javascript:void(0);" onclick="restack(currentStack)" title="Change Orientation" class="w3-btn w3-bar-item topnav-icons fa fa-rotate" style="font-size:28px;color:#999999;margin-top:-2px" ><i class="material-icons" style="font-size:36px">screen_rotation</i></a>-->
    
  <button class="w3-btn w3-bar-item w3-green w3-hover-white w3-hover-text-green" onclick="submitTryit(1)">Run &raquo;</button>
